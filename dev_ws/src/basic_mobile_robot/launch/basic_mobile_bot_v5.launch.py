...
def generate_launch_description():
    ...
    pkg_share = FindPackageShare(
        package='basic_mobile_robot').find('basic_mobile_robot')
    ...
    world_file_name = 'basic_mobile_bot_world/projectWorldEnd.world'
    world_path = os.path.join(pkg_share, 'worlds', world_file_name)
    nav2_dir = FindPackageShare(package='nav2_bringup').find('nav2_bringup')
    nav2_launch_dir = os.path.join(nav2_dir, 'launch')
    static_map_path = os.path.join(pkg_share, 'maps', 'house_map.yaml')
    nav2_params_path = os.path.join(pkg_share, 'params', 'nav2_params.yaml')
    nav2_bt_path = FindPackageShare(
        package='nav2_bt_navigator').find('nav2_bt_navigator')
